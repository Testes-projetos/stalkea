        ...
        <div className={styles.modalHeader}>
          ...
          <p className={styles.modalSubtitle}>
            {modalProfileData.fromApi
              ? <>Perfil encontrado! Confirmar espionagem com <span className={styles.highlightUsername}>@{username}?</span>?</>
              : <>Vamos realizar a espionagem em <span className={styles.highlightUsername}>@{username}</span>?</>
            }
          </p>
        </div>
