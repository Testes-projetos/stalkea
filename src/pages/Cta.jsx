...
const Cta = () => {
  ...
  useEffect(() => {
    const msgs = [
      { text: 'E aí, bora testar o clone do insta?', sent: false },
  ...
  const testimonials = [
    { avatar: av1, name: 'Marcosvianad', time: '3h', text: 'Achei q era golpe mas testei msm assim. Paguei, em 3 min recebi o acesso. Tava tudo lá: direct.' },
    { avatar: av2, name: 'Gieselferreira_34', time: '5h', text: 'O acesso foi super rapido. Paguei no pix e em menos de 2 min já tava vendo tudo.' },
    { avatar: av3, name: 'o__prozind34', time: '1d', text: 'Na versão completa testei e funcionou perfeitamente. Recomendo demais.' }
  ];

  const faqs = [
    { q: 'A ferramenta realmente funciona?', a: 'Sim! Milhares de pessoas já usaram e aprovaram.' },
    { q: 'É seguro usar?', a: 'Totalmente. O software é de confiança e seus dados ficam protegidos.' },
    { q: 'Preciso instalar alguma coisa?', a: 'Não! Funciona totalmente na nuvem, direto pelo navegador.' },
      ...
      <div className={s.timerBar}>
        <div className={s.timerContent}>
          ...
          <div className={s.timerText}>
            <strong>Finalize sua compra em <span className={s.timerCountdown}>{countdown}</span></strong>
            <span className={s.timerWarning}>
              Ao zerar o cronômetro, nunca mais vai ser possível espionar{' '}
      ...
      <div className={s.container}>
        ...
        <div className={s.logoSection}>
          ...
          <h1 className={s.mainTitle}>
            A maior ferramenta<br />de <span className={s.gradient}>Clone</span> do Brasil
          </h1>
        </div>
        ...
        <div className={s.vipBadge}>
          ...
          <div className={s.vipBadgeInfo}>
            <strong>Acesso VIP liberado para {storedUsername}</strong>
        ...
        <section className={s.featuresSection}>
          ...
          <div className={s.featureCard}>
            <div className={s.featureHeader}>
              ...
              <div>
                <h3 className={s.featureTitle}>Mídias de {storedUsername}</h3>
                <p className={s.featureDesc}>Veja todas as mídias recebidas e enviadas</p>
              </div>
            </div>
            <div className={s.mediaGrid}>
              <div className={s.mediaLarge} onClick={() => setPopup({ show: true, text: 'às mídias' })}>
                <img src={fotoblur1} alt="" />
              ...
              {galleryImages.map((img, i) => (
                <div key={i} className={s.mediaItem} onClick={() => setPopup({ show: true, text: 'às mídias' })}>
                  <img src={img} alt="" />
                  <div className={s.mediaLock}>
          ...
          <div className={s.featureCard}>
            <div className={s.featureHeader}>
              ...
              <div>
                <h3 className={s.featureTitle}>Localização em tempo real</h3>
                <p className={s.featureDesc}>Veja onde {storedUsername} está agora</p>
              </div>
            </div>
            <div className={s.mapContainer}>
              ...
              <div className={s.mapInfo}>
                <div>
                  <div className={s.mapInfoLabel}>Localização Atual</div>
                  <div className={s.mapInfoUser}>@{storedUsername}</div>
                </div>
                <button className={s.mapButton} onClick={() => setPopup({ show: true, text: 'à localização' })}>Ver</button>
              </div>
            </div>
          </div>
          ...
          <div className={s.featureCard}>
            <div className={s.featureHeader}>
              ...
              <div>
                <h3 className={s.featureTitle}>Stories e posts ocultos</h3>
                <p className={s.featureDesc}>Veja stories de "Melhores Amigos" de {storedUsername}</p>
              </div>
            </div>
            <div className={s.storiesGrid}>
              {[story1, story2].map((img, i) => (
                <div key={i} className={s.storyItem} onClick={() => setPopup({ show: true, text: 'aos stories' })}>
                  <img src={img} alt="" />
          ...
          <div className={s.featureCard}>
            <div className={s.featureHeader}>
              ...
              <div>
                <h3 className={s.featureTitle}>Mensagens do Direct</h3>
                <p className={s.featureDesc}>Veja todas as mensagens de {storedUsername}</p>
              </div>
            </div>
        ...
        <section className={s.pricingSection} id="pricing">
          <div className={s.pricingHeader}>
            ...
            <h2 className={s.pricingTitle}>
              Com o <span className={s.gradient}>Stalkea.ai</span> você vai ter<br />
              acesso completo ao clone de<br />
          ...
          <ul className={s.pricingBenefits}>
            {[
              <>Directs completos de <strong>{storedUsername}</strong></>,
              'Todas as mídias recebidas e enviadas',
              'Localização em tempo real',
              <>Alerta sempre que <strong>{storedUsername}</strong> interagir com alguém</>,
        ...
        <section className={s.testimonialsSection}>
          <h2 className={s.testimonialsTitle}>
            Veja o que falam do <span className={s.gradient}>Stalkea.ai</span>
          </h2>
        ...
        <div className={s.footerWarning}>
          <div className={s.footerWarningContent}>
            <div className={s.footerWarningText}>
              <strong>Finalize sua compra em {countdown}</strong>
              <span>Ao zerar, nunca mais será possível acessar {storedUsername}.</span>
            </div>
